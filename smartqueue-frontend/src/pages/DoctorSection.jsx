...
const DoctorSection = () => {
    ...
    const fetchDoctors = async () => {
        try {
            ...
            if (response.ok) {
                ...
                // Inactive/deleted doctors ko main list me show nahi karna
                setDoctors(data.filter(doc => doc.active !== false));
            }
        } catch (error) {
    ...
    const handleAddDoctorSubmit = async (e) => {
        ...
        const doctorDTO = {
            ...
            specialization:
                newDoc.specialization || newDoc.department,
            email: newDoc.email,
            password: newDoc.password,
            phone: newDoc.phone,
            roomNumber: newDoc.roomNumber,
            consultationFee:
                parseFloat(newDoc.consultationFee) || 500,
            availableTime:
                newDoc.availableTime ||
                "10:00 AM - 02:00 PM"
        };
    ...
    const handleDeleteDoctor = async (id) => {
        if (
            ...
            try {
                const response = await fetch(
                    `http://localhost:8081/api/admin/doctor/${id}`,
                    {
                        method: 'DELETE'
                    }
                );
                ...
                if (response.ok) {
                    ...
                    // Backend me doctor active=false hoga
                    // fetchDoctors() inactive doctor ko list se hata dega
                    fetchDoctors();
                } else {
                    let errorText =
        ...
        <div className="doctor-section-container">
            ...
            <div className="doc-header">
                ...
                <div className="doc-header-title">
                    ...
                    <p>
                        Monitor doctor schedules, patient
                        assignments, and active availability.
                    </p>
                </div>
